...
Functions:
    ...
    perform_operation(operation, num1, num2=None): Performs the selected mathematical operation
...
def perform_operation(operation: str, num1: float, num2: float = None) -> float:
    ...
    Parameters:
        ...
        num2 (float, optional): The second number for binary operations
...
def main() -> None:
    ...
    while True:
        try:
            ...
            if choice == '8':
                logger.info("Calculator program terminated by user")
            ...
            # Get input(s) based on operation
            if choice in ['6', '7']:  # Single number operations
